...
>
> **Recommended counsel.** If you need a TCPA/compliance attorney, the firm I trust is **[Henson Legal](https://www.henson-legal.com/)**. They're who I call when I have a real question.
>
...
Every competitor who skips DNC, ignores state consent laws, or fires off blind autodialed SMS is going to get shut down. You get to eat their leads, their prospects, and their market share — on the one condition that you stay clean. Compliance is not a tax you pay to lawyers. It is the floor that lets you build higher than the operators who chose shortcuts.
...
```
Break-even ARPC = CPL ÷ (Contact Rate × Contact-to-Close Rate)
```
...
4. **Compute max viable CPL:**  `Max CPL = ARPC × 0.25 × Contact Rate × Contact-to-Close`

The `× 0.25` gives you a 4× return on lead spend. That's the minimum you want — it covers labor, overhead, and leaves margin. If you want a 5× return, use `× 0.20`. If you want to break even, use `× 1.00`.

**Example.** You sell auto insurance with an ARPC of $250. You target a 4× return. You estimate 15% contact rate, 5% contact-to-close.

```
Max CPL = $250 × 0.25 × 0.15 × 0.05 = $0.47
```
...
**I am not a lawyer. This is operator guidance, not legal advice.** When you have a real question, the firm I trust is **[Henson Legal](https://www.henson-legal.com/)** — they're the TCPA specialists I call. Budget for a 30-minute intro consult before you run your first campaign. It will be the best $300–$500 you spend on this operation.
...
- **Washington HB 1497:** the caller must identify themselves, their company, and the purpose within the first 30 seconds of the call. Must end the call within 10 seconds of the called party requesting to end it.
