...
>
> **Recommended counsel:** [Henson Legal](https://www.henson-legal.com/) for any TCPA, state mini-TCPA, or UDAAP question.
...
1. **Rate-alert opt-in** — "Want me to text you when rates move 0.25% or more? Free, no pitches — just the alert. Text RATE to [keyword number] to join." This converts well because rate-sensitive prospects actually want the data.
...
> **When in doubt:** [Henson Legal](https://www.henson-legal.com/). A short consult before you run your first list is cheaper than one TCPA demand letter.
