...
export const EDITORIAL_CALENDAR: ContentBrief[] = [
  ...
  { week: 9, day: "Wed", publishDate: "2026-05-13", slug: "aged-lead-text-sms-strategies", title: "Texting Aged Leads the Right Way: Earn Consent First", pillar: "Channel Tactics", primaryKeyword: "texting aged leads consent", secondaryKeywords: ["SMS aged leads consent", "TCPA text message rules", "earn consent before texting leads"], targetLeadTypes: ["lt-insurance", "lt-solar"], wordCount: "2,000", competitiveAngle: "Re-angled consent-first (2026-06-13): purchased/aged data is NOT consented contact data, so cold-texting it is a TCPA danger zone. The honest playbook is to EARN consent first (email-first warm-up + a scheduling/booking link that captures phone+text permission), then text only the consented. Flips the old pro-SMS stance; pairs with the call-recording-consent and scheduling-links pieces.", outline: ["Why cold-texting purchased aged data is a TCPA trap (prior express written consent)", "The reframe: aged data earns a conversation, not a text blast", "Email-first warm-up to open the door without texting", "Capturing phone + text consent at the booking link", "What you can text once you have consent (templates)", "SMS in a consented multi-channel cadence", "Compliant texting platforms — and what they can't fix (missing consent)"], internalLinks: ["/glossary/tcpa", "/glossary/multi-channel-outreach", "/compare/aged-vs-real-time-leads"], status: "brief" },
