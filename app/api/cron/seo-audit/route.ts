...
<body style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;color:#1f2937;max-width:900px;margin:0 auto;padding:20px;">
    ...
    <table style="width:100%;" cellpadding="0" cellspacing="0">
      <tr>
        <td>
          ...
          <p style="margin:0;opacity:0.85;font-size:14px;">Aged Lead Sales — ${report.runDate.split("T")[0]}</p>
        </td>
  ...
  <p style="color:#9ca3af;font-size:12px;">Generated by the Aged Lead Sales SEO audit cron job. Full backlog saved to data/seo-backlog.json. Audit details saved to data/seo-audits/${report.runDate.split("T")[0]}.json.</p>
</body></html>`;
}
